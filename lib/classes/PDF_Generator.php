...
class PDF_Generator {
	...
	public function generate_pdf( $html_path, $data, $file_name, $save_dir = '' ) {
		...
		$mpdf->DefHTMLHeaderByName('header', '<img src="' . hm_get_svg_as_colorized_png( THEME_ASSETS_PATH . '/pdfs/img/header.svg', THEME_BRAND_COLOR_MAIN ) . '" />');
		$mpdf->DefHTMLFooterByName('footer', '<img src="' . hm_get_svg_as_colorized_png( THEME_ASSETS_PATH . '/pdfs/img/footer.svg', THEME_BRAND_COLOR_MAIN ) . '" />');

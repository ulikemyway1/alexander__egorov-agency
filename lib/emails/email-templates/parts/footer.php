...
namespace Harbinger_Marketing;
													...
													<tr>
														...
														<![endif]-->
															<div style="display: inline-block; width: 100%; max-width: 300px; padding: 10px 0; vertical-align: top;">
																<?php $pin_icon_url = hm_get_svg_as_colorized_png( THEME_ASSETS_PATH  . '/branding/images/icons/pin-icon.svg', THEME_BRAND_COLOR_MAIN ) ?>
																...
																<table role="presentation" style="width: 100%; border: none; border-spacing: 0; border-collapse: collapse;">
																	<tr>
																		...
																		<![endif]-->
																			<img src="<?php echo $pin_icon_url ?>" style="margin-bottom: 15px;" width="25" height="<?php echo 25 / hm_get_image_aspect_ratio( $pin_icon_url ) ?>">
																		<!--[if mso]>
																		</td>
																	</tr>
																</table>
														...
														<![endif]-->
															<div style="display: inline-block; width: 100%; max-width: 300px; padding: 10px 0; vertical-align: top;">
																<?php $computer_icon_url = hm_get_svg_as_colorized_png( THEME_ASSETS_PATH  . '/branding/images/icons/computer-icon.svg', THEME_BRAND_COLOR_MAIN ) ?>
																...
																<table role="presentation" style="width: 100%; border: none; border-spacing: 0; border-collapse: collapse;">
																	<tr>
																		<td style="padding: 0 0 15px;">
																		<![endif]-->
																			<img src="<?php echo $computer_icon_url ?>" style="margin-bottom: 15px;" width="30" height="<?php echo 30 / hm_get_image_aspect_ratio( $computer_icon_url ) ?>">
																		<!--[if mso]>
																		</td>
																	</tr>
																</table>
														...
														<![endif]-->
															<div style="display: inline-block; width: 100%; max-width: 300px; padding: 10px 0; vertical-align: top;">
																<?php $clock_icon_url = hm_get_svg_as_colorized_png( THEME_ASSETS_PATH  . '/branding/images/icons/clock-icon.svg', THEME_BRAND_COLOR_MAIN ) ?>
																...
																<table role="presentation" style="width: 100%; border: none; border-spacing: 0; border-collapse: collapse;">
																	<tr>
																		<td style="padding: 0 0 15px;">
																		<![endif]-->
																			<img src="<?php echo $clock_icon_url ?>" style="margin-bottom: 15px;" width="30" height="<?php echo 30 / hm_get_image_aspect_ratio( $clock_icon_url ) ?>">
																		<!--[if mso]>
																		</td>
																	</tr>
																</table>
					...
					<!-- Footer -->
					<table role="presentation" style="width: 100%; border: none; border-spacing: 0; border-collapse: collapse; background: <?php echo THEME_BRAND_COLOR_TERTIARY ?>">
						<tr>
							<td style="text-align: center; padding: 20px 0;">
								<a href="<?php echo $is_notification ? HARBINGER_MARKETING_WEBSITE_URL : get_bloginfo('url') ?>" target="_blank" style="display: block; width: 100%; max-width: 120px; margin: 0 auto;">
									<?php if ( $is_notification ) : ?>
										<?php $harbinger_logo_url = hm_get_svg_as_colorized_png( HARBINGER_MARKETING_LOGO_PATH, 'white' ) ?>

										<img src="<?php echo $harbinger_logo_url ?>" alt="" style="display: block;" width="120" height="<?php echo 120 / hm_get_image_aspect_ratio( $harbinger_logo_url ) ?>">
									<?php else : ?>
										<img src="<?php echo hm_get_svg_as_colorized_png( THEME_LOGO_URL, 'white' ); ?>" alt="" style="display: block;" width="120" height="<?php echo 120 / hm_get_image_aspect_ratio( THEME_LOGO_URL ) ?>">
									<?php endif ?>
								</a>
							</td>
						</tr>

...
<table role="presentation" style="width: 100%; border: none; border-spacing: 0; border-collapse: collapse;">
	<tr>
		<td align="center" style="padding: 0 20px 50px;">
			...
			<table role="presentation" style="width: 100%; max-width: 900px; border: none; border-spacing: 0; border-collapse: collapse; margin: 0 auto;">
				<tr>
					<td style="width: 100%; padding: 0;">
						<?php foreach ( $fields as $i => $field ) :
							...
							<div style="font-size: 0; padding: 10px 0 5px; <?php echo $i ? 'border-top: 1px solid ' . THEME_BRAND_COLOR_TERTIARY . ';' : '' ?>">
								<!--[if mso]>
								<table role="presentation" style="border: none; border-spacing: 0; border-collapse: collapse; <?php echo $i ? 'border-top: 1px solid ' . THEME_BRAND_COLOR_TERTIARY . ';' : '' ?>">
									<tr>
										...
										<![endif]-->
											<div style="display: inline-block; width: 100%; max-width: 450px; text-align: right; vertical-align: top;">
												<p style="font-size: 16px; padding: 0 25px 5px 0; margin: 0;">
										...
										<![endif]-->
											<div style="display: inline-block; width: 100%; max-width: 450px; vertical-align: top;">
																			...
																			<![endif]-->
																				<ul style="list-style-position: inside; padding: 0 0 <?php echo $i != ( $values_count - 1 ) ? '5px' : '0' ?>; margin: 0;">
																					<?php foreach ( $field['fields'] as $sub_field_key => $sub_field_settings ) : ?>
																						<li style="font-size: 16px; padding: 0 0 5px; margin: 0;">
